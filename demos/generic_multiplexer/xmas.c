...
#define XTREE_LIGHT_1 (COLOR+TREE_LEVEL(4)+2)
#define XTREE_LIGHT_2 (COLOR+TREE_LEVEL(3)+2)
#define XTREE_LIGHT_3 (COLOR+TREE_LEVEL(3)+3)
#define XTREE_LIGHT_4 (COLOR+TREE_LEVEL(2)+2)
#define XTREE_LIGHT_5 (COLOR+TREE_LEVEL(2)+3)
...
void draw_xmas_tree(void)
{
	...
	POKE(SCREEN+TREE_LEVEL(5)+2,TILE_BASE);
	POKE(SCREEN+TREE_LEVEL(5)+3,TILE_BASE+1);

	POKE(SCREEN+TREE_LEVEL(4)+1,  TILE_BASE+2);
	POKE(SCREEN+TREE_LEVEL(4)+2,TILE_BASE+3);	
	POKE(SCREEN+TREE_LEVEL(4)+3,TILE_BASE+4);
	POKE(SCREEN+TREE_LEVEL(4)+4,TILE_BASE+5);	

	POKE(SCREEN+TREE_LEVEL(3)+1,  TILE_BASE+2);
	POKE(SCREEN+TREE_LEVEL(3)+2,TILE_BASE+3);	
	POKE(SCREEN+TREE_LEVEL(3)+3,TILE_BASE+4);
	POKE(SCREEN+TREE_LEVEL(3)+4,TILE_BASE+5);	

	POKE(SCREEN+TREE_LEVEL(2)+1,  TILE_BASE+6);
	POKE(SCREEN+TREE_LEVEL(2)+2,TILE_BASE+7);	
	POKE(SCREEN+TREE_LEVEL(2)+3,TILE_BASE+8);
	POKE(SCREEN+TREE_LEVEL(2)+4,TILE_BASE+9);	

	POKE(SCREEN+TREE_LEVEL(1)+1,  TILE_BASE+6);
	POKE(SCREEN+TREE_LEVEL(1)+2,TILE_BASE+7);	
	POKE(SCREEN+TREE_LEVEL(1)+3,TILE_BASE+8);
	POKE(SCREEN+TREE_LEVEL(1)+4,TILE_BASE+9);	

	POKE(SCREEN+TREE_LEVEL(0)+1,  TILE_BASE+10);
	POKE(SCREEN+TREE_LEVEL(0)+2,TILE_BASE+11);	
	POKE(SCREEN+TREE_LEVEL(0)+3,TILE_BASE+12);
	POKE(SCREEN+TREE_LEVEL(0)+4,TILE_BASE+13);	
    
	
	POKE(COLOR+TREE_LEVEL(5)+2,RED+MULTI_COLOR_BIT);
	POKE(COLOR+TREE_LEVEL(5)+3,YELLOW+MULTI_COLOR_BIT);

	POKE(COLOR+TREE_LEVEL(4)+1,  3+MULTI_COLOR_BIT);
	POKE(COLOR+TREE_LEVEL(4)+2,YELLOW+MULTI_COLOR_BIT);	
	POKE(COLOR+TREE_LEVEL(4)+3,RED+MULTI_COLOR_BIT);
	POKE(COLOR+TREE_LEVEL(4)+4,3+MULTI_COLOR_BIT);	

	POKE(COLOR+TREE_LEVEL(3)+1,  3+MULTI_COLOR_BIT);
	POKE(COLOR+TREE_LEVEL(3)+2,YELLOW+MULTI_COLOR_BIT);	
	POKE(COLOR+TREE_LEVEL(3)+3,RED+MULTI_COLOR_BIT);
	POKE(COLOR+TREE_LEVEL(3)+4,3+MULTI_COLOR_BIT);	

	POKE(COLOR+TREE_LEVEL(2)+1,  4+MULTI_COLOR_BIT);
	POKE(COLOR+TREE_LEVEL(2)+2,RED+MULTI_COLOR_BIT);	
	POKE(COLOR+TREE_LEVEL(2)+3,YELLOW+MULTI_COLOR_BIT);
	POKE(COLOR+TREE_LEVEL(2)+4,4+MULTI_COLOR_BIT);	

	POKE(COLOR+TREE_LEVEL(1)+1,  4+MULTI_COLOR_BIT);
	POKE(COLOR+TREE_LEVEL(1)+2,RED+MULTI_COLOR_BIT);	
	POKE(COLOR+TREE_LEVEL(1)+3,YELLOW+MULTI_COLOR_BIT);
	POKE(COLOR+TREE_LEVEL(1)+4,4+MULTI_COLOR_BIT);	
	
	POKE(COLOR+TREE_LEVEL(0)+1,  GREEN+MULTI_COLOR_BIT);
	POKE(COLOR+TREE_LEVEL(0)+2,RED);	
	POKE(COLOR+TREE_LEVEL(0)+3,RED);
	POKE(COLOR+TREE_LEVEL(0)+4,GREEN+MULTI_COLOR_BIT);		
	// {}
}
